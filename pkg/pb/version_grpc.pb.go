...
const (
	VersionService_GetVersion_FullMethodName = "/api.proto.v1.VersionService/GetVersion"
)
...
var VersionService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.proto.v1.VersionService",
	...
	Metadata: "api/proto/v1/version.proto",
}
